...
module.exports = {
  deletePost: function (req, res, _, userId, postId) {
  ...
  editPost: function (req, res, _, body, userId, postId) {
  ...
  findPosts: function (req, res, _, title, category) {
  ...
  showPost: function (req, res, _, postId) {
  ...
  showUserPosts: function (req, res, _, userId) {
  ...
  uploadPost: function (req, res, _, body) {
