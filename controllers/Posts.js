...
module.exports = {
  deletePost: function (req, res, next, userId, postId) {
  ...
  editPost: function (req, res, next, body, userId, postId) {
  ...
  findPosts: function (req, res, next, title, category) {
  ...
  showPost: function (req, res, next, postId) {
  ...
  showUserPosts: function (req, res, next, userId) {
  ...
  uploadPost: function (req, res, next, body) {
